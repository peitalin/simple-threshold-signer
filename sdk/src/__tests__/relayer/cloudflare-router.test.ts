...
test.describe('relayer router (cloudflare) – P0', () => {
  ...
  test('POST /login/verify: verified + sessionKind=cookie sets Set-Cookie and does not include jwt', async () => {
  ...
  test('POST /login/verify: session failures are best-effort (still 200)', async () => {
    const session = makeSessionAdapter({
