...
- Sets `window.__W3A_SIGNER_WORKER_URL__` and `window.__W3A_SECURE_CONFIRM_WORKER_URL__` to the offline‑scoped worker copies so their WASM fetches stay inside the SW scope.
