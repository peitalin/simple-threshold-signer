 ...
 *   `globalThis.awaitSecureConfirmationV2` in `sdk/src/core/web3authn-secure-confirm.worker.ts`.
 *
 * High-level flow:
 ...
 * 3) `SecureConfirmWorkerManager` intercepts that message and runs confirmTxFlow on the main thread
