/**
 * SecureConfirm Web Worker (legacy runtime removed)
 *
 * This worker previously hosted a legacy challenge WASM runtime. In the lite threshold-signer
 * refactor we removed that runtime and kept this worker bundle as a home for the
...
} from '../signing/secureConfirm/confirmTxFlow/awaitSecureConfirmation';
import { SecureConfirmMessageType } from '../signing/secureConfirm/confirmTxFlow/types';
