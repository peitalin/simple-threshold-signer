...
- File: `client/src/core/WebAuthnManager/LitComponents/confirm-ui.ts`
- Element contract: `client/src/core/WebAuthnManager/LitComponents/confirm-ui-types.ts`
...
- `client/src/core/WebAuthnManager/SecureConfirmWorkerManager/confirmTxFlow/handleSecureConfirmRequest.ts` (SHOW_SECURE_PRIVATE_KEY_UI path) dynamically imports the iframe host module before creating the element.
...
```ts
// client/src/core/WebAuthnManager/LitComponents/ensure-defined.ts
