...
- `client/src/core/WebAuthnManager/LitComponents/css/css-loader.ts`
...
- Verify changes to `client/src/core/WebAuthnManager/LitComponents/css/w3a-components.css` and commit.
