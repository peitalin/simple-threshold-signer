...
import type { SigningWorkerManagerContext } from './index';

export class NearSigningKeyOpsService {
  private readonly getContext: () => SigningWorkerManagerContext;

  constructor(getContext: () => SigningWorkerManagerContext) {
