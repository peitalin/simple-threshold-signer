 ...
 *
 * This is used when the host (main thread) needs a registration credential + NEAR context,
 * but the UI/confirmation orchestration lives in the SecureConfirm worker confirmation flow.
 */
export async function requestRegistrationCredentialConfirmation(
  ctx: SecureConfirmWorkerManagerHandlerContext,
  params: {
