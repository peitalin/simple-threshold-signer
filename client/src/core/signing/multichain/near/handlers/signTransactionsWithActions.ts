...
import type { MultichainSignerRuntimeDeps } from '../../shared/types';
import { PASSKEY_MANAGER_DEFAULT_CONFIGS } from '../../../../config/defaultConfigs';
import { toAccountId } from '../../../../types/accountIds';
import {
  getLastLoggedInDeviceNumber,
  parseDeviceNumber,
} from '../../../../WebAuthnManager/SignerWorkerManager/getDeviceNumber';
...
} from '../../../schemes/threshold/session/thresholdEd25519RelayerHealth';
...
} from '../../../schemes/threshold/session/thresholdEd25519AuthSession';
import type { SigningAuthMode } from '../../../../WebAuthnManager/SecureConfirmWorkerManager/confirmTxFlow/types';
import {
  buildThresholdSessionPolicy,
  isThresholdSessionAuthUnavailableError,
  isThresholdSignerMissingKeyError,
} from '../../../schemes/threshold/session/thresholdSessionPolicy';
import { normalizeThresholdEd25519ParticipantIds } from '../../../../../../../shared/src/threshold/participants';
import { deriveThresholdEd25519ClientVerifyingShare } from '../../../../WebAuthnManager/SignerWorkerManager/keyOps/deriveThresholdEd25519ClientVerifyingShare';
...
function getPrfResultsFromCredential(credential: unknown): { first?: string; second?: string } {
  try {
    ...
    const second =
      typeof (results as any).second === 'string' ? (results as any).second.trim() : '';
    return {
      ...(first ? { first } : {}),
      ...(second ? { second } : {}),
    };
...
> {
  ...
  const nearIntent = await new NearAdapter().buildIntent({
    ...
    nearAccountId: resolvedRpcCall.nearAccountId,
    transactions,
  });
