...
import { ActionType, type ActionArgsWasm, type TransactionInputWasm } from '../types';
...
export async function computeUiIntentDigestFromNep413(args: {
  ...
  // This is a UI/host binding digest. It is NOT the NEP-413 signing hash.
...
export async function computeThresholdEcdsaKeygenIntentDigest(args: {
  ...
  // WebAuthn-only keygen challenge policy (v1). This digest is used as the raw WebAuthn
  // challenge bytes (32 bytes) during `/threshold-ecdsa/keygen`.
